  ...
  <div class="login-body">
    ...
    <div class="login-wrap comm-flex-box">
      <div class="login-image">
        <img class="dashboard-img" v-if="dashboardImg" :src="dashboardImg" alt="dashboard img" />
      </div>
        ...
        <el-form ref="loginForm" :model="formData" class="login-form">
          ...
          <el-form-item class="form-item">
            <el-tooltip content="功能暂不开放">
              <el-checkbox v-model="formData.keeping" :disabled="true" title="功能暂不开放">{{
                $t('login.keeping')
              }}</el-checkbox>
            </el-tooltip>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    confirmLogin() {
      ...
      return this.$DS.login(this.formData).catch(
        err =>
